<div class="edit-profile-container position-relative">
    ...
    <form action="{{ route('addNewLowongan') }}" method="post">
        ...
        <div class="kolom mb-3">
            ...
            <input required type="text" class="form-control" id="posisi" placeholder="Contoh: Frontend Developer"
                name="judul_lowongan">
        </div>
        ...
        <div class="kolom mb-3">
            ...
            <input required type="number" class="form-control" name="gaji_minimum" placeholder="Contoh: 3000000">
        </div>

        <div class="kolom mb-3">
            <label for="gaji_maksimum" class="form-label text-white">Gaji Maksimum</label>
            <input required type="number" class="form-control" name="gaji_maximum" placeholder="Contoh: 8000000">
        </div>

        <div class="kolom mb-3">
            <label for="kualifikasi" class="form-label text-white">Kualifikasi</label>
            <textarea class="form-control" id="kualifikasi" name="kualifikasi" rows="6"
                placeholder="Masukkan kualifikasi yang dibutuhkan..."></textarea>
        </div>

        <div class="kolom mb-3">
            <label for="deskripsi" class="form-label text-white">Deskripsi Pekerjaan</label>
            <textarea class="form-control" id="deskripsi" rows="6" placeholder="Masukkan deskripsi pekerjaan..."
